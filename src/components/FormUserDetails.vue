  ...
  <div>
    ...
    <form @input="submit" class="form">
      <div class="form-group">
        ...
        <!-- the input action there is to fire a method when the users finish inputting their data -->
        <input @input="checkIfUserExists" type="text" v-model="$v.form.email.$model" placeholder="your@email.com" class="form-control" id="email">
